...
def combine_csv_files(directory, output_file):
    ...
    for file in csv_files:
        ...
        # Filter out rows where 'CURRENCY' is not 'AUD'
        df = df[df['CURRENCY'] == 'AUD']
...
directory = './asx-etfs/raw/'  # Assuming the Canadian ETF files are in this directory
output_file = 'combined_asx_etf.csv'
